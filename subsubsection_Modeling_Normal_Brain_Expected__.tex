...
\par
Non-WMC voxels are used to create a one-class single-node support vector machine \cite{22921728}\cite{18252603} at each voxel. This model will be used in removing evident normal brain.