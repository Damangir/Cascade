...
int main(int argc, char *argv[])
{
  ...
  itk::NumericTraits< ImageType::PixelType >::SetLength(
      pixel, movingImageReader->GetOutput()->GetNumberOfComponentsPerPixel());

  resample->SetDefaultPixelValue(itk::NumericTraits< ImageType::PixelType >::ZeroValue(pixel));
